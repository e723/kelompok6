	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo site_url(); ?>">
				<img alt="<?php echo config_item('web_title'); ?>" src="<?php echo config_item('img'); ?>logo2.png">
			</a>
		</div>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<?php if($level == 'admin') { ?>
				<li><a href="<?php echo site_url('grafik'); ?>"><i class="glyphicon glyphicon-briefcase"></i>Statistik Penjualan</a></li>
				<?php } ?>
